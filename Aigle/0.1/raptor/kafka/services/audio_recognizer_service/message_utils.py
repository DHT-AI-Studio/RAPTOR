# services/audio_recognizer_service/message_utils.py
...
class MessageBuilder:
    ...
    def create_response(
        ...
        return MessageBuilder.create_message(
            source_service="audio_recognizer_service",
    ...
    @staticmethod
    def create_recognition_result_message(
        original_message: Dict[str, Any],
        recognition_results: Dict[str, Any]
    ) -> Dict[str, Any]:
        """創建音頻識別結果消息"""
        result_path = recognition_results.get("parameters", {}).get("recognition_result_path")
        processing_time = recognition_results.get("parameters", {}).get("processing_time_seconds", 0)
        payload = {
