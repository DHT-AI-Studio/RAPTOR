# services/audio_orchestrator_service/api_client.py
                        ...
                        if response.status == 200:
                            ...
                            async with session.get(file_url) as file_response:
                                if file_response.status == 200:
                                    ...
                                    logger.info(f"Audio file downloaded successfully: {temp_file_path}")
                            ...
                            # 檔案不存在不重試
                            logger.error(f"Audio file not found: {asset_path}/{version_id}")
                            raise ValueError(f"Audio file not found: {asset_path}/{version_id}")
