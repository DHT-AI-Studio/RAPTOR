...
SYNC_API_PORT = int(os.getenv("PORT_DOCUMENT_SYNC_API", "8020"))
...
async def main():
    ...
    analysis_client = DocumentAnalysisClient(
        ...
        inference_think=INFERENCE_THINK,
    )
    summarizer = DocumentSummarizer(inference_url=INFERENCE_URL, model_name=INFERENCE_MODEL, think=INFERENCE_THINK)
