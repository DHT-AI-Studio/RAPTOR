# services/audio_summary_service/config.py
...
KAFKA_TOPIC_DLQ = "audio-summary-dlq"
...
# 服務配置
SERVICE_NAME = "audio_summary_service"
LOG_LEVEL = "INFO"

# 臨時檔案配置
TEMP_FILE_DIR = "/tmp/media_processing/audio_processing"
