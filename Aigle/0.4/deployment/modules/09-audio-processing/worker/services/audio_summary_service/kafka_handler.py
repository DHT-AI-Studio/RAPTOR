    ...
    def summarize_audio_sync(self, request_payload: Dict[str, Any], kafka_message: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            summary_result_path = os.path.join(
                SUMMARY_RESULTS_DIR,
                f"audio_summary_result_{request_id}.json"
            )
            ...
            try:
                ...
                _audio_filename = parameters.get("filename", filename)
                summary_item = {
                    "id": summary_id,
                    "payload": {
                        "filename": _audio_filename,
                        "type": "audios",
                        "source": _audio_filename.rsplit('.', 1)[-1].lower(),
                ...
                try:
                    ...
                    logger.warning(f"Failed to clean up analysis file {file_path}: {cleanup_err}")
