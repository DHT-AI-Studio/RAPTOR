...
KAFKA_TOPIC_INDEXER_REQUEST = "audio-indexer-requests"
...
KAFKA_TOPIC_INDEXER_RESULT = "audio-indexer-results"
...
MERGED_FILE_DIR = "/tmp/media_processing/audio_processing/merged"
