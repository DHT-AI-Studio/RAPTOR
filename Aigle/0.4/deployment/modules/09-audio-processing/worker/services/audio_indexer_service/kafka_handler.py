# services/audio_indexer_service/kafka_handler.py
...
class AudioIndexerKafkaHandler:
    def __init__(self):
        self.consumer = None
        self.producer = None
    ...
    async def process_message(self, message: Dict[str, Any]):
        ...
        try:
            ...
            # deletes summary_result_path — that file is the only copy of the
            # entries here. Fire-and-forget: never fails this handler.
            await publish_personal_index(
                self.producer,
                source_module="09-audio",
                entries_path=summary_result_path,
            )
            ...
            if summary_result_path:
                try:
                    ...
                    logger.warning(f"Failed to clean up summary file {summary_result_path}: {cleanup_err}")
