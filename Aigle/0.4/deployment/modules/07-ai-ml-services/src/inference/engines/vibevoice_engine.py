...
and microsoft/VibeVoice-1.5B (TTS task).

DEPRECATED: This is a v2-era standalone engine kept only to back the legacy
`/inference/tts` endpoint (still consumed by module 09). It does NOT participate
in the v3 spec-driven InferenceService / Adapter / Handler pipeline. When TTS is
rewritten as a HF `custom_handler`, delete this file and `tts_api.py`.
"""
...
class VibeVoiceEngine:
    ...
    # ── public interface (formerly BaseEngine) ──────────────────────────────
