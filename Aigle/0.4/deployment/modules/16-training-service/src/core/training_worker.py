...
def run_in_dedicated_process_and_terminate(
    ...
    # Tag this training process (and every torch spawn child that inherits the
    # env) so the startup orphan-reaper can identify leftover training workers
    # WITHOUT mistaking the uvicorn API worker for one. See core/orphan_reaper.py.
    env["RAPTOR_TRAINING_CHILD"] = "1"
