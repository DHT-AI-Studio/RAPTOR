...
Primary:  Module 17 /api/v1/search/rerank
...
def _do_rerank(req: RerankerRequest) -> SearchResult:
    ...
    reranked = _rerank_module17(req.query, deduped, req.top_k)
    source   = "reranker:module17"
    if reranked is None:
...
agent_card = AgentCard(
    name="reranker_agent",
    description="Re-scores merged candidates. Primary: Module 17 rerank. Fallback: local cross-encoder.",
    version="0.3.0",
