...
A2A wrapper for BM25 keyword search via Module 17 (raptor-hybridsearch-api).
Backend: POST /api/v1/search/bm25
"""
...
agent_card = AgentCard(
    ...
    description="BM25 keyword search via Module 17 (OpenSearch).",
    version="0.3.0",
