...
KC_ADMIN  = os.getenv("PERMANENT_MASTER_ADMIN_USER", "")
KC_PASS   = os.getenv("PERMANENT_ADMIN_PASSWORD", "")
KC_REALM  = os.getenv("KEYCLOAK_REALM", "dhtsolution")
KC_CLIENT = os.getenv("KEYCLOAK_CLIENT_ID", "raptor")
