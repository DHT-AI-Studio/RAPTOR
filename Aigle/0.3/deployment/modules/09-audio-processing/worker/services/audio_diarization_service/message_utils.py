# services/audio_diarization_service/message_utils.py
...
class MessageBuilder:
    ...
    def create_response(
        ...
        return MessageBuilder.create_message(
            source_service="audio_diarization_service",
    ...
    @staticmethod
    def create_diarization_result_message(
        original_message: Dict[str, Any],
        diarization_results: Dict[str, Any]
    ) -> Dict[str, Any]:
        """創建音頻說話人分離結果消息"""
        result_path = diarization_results.get("parameters", {}).get("diarization_result_path")
        processing_time = diarization_results.get("parameters", {}).get("processing_time_seconds", 0)
        payload = {
