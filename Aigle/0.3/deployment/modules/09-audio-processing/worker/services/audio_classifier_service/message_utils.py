# services/audio_classifier_service/message_utils.py
...
class MessageBuilder:
    ...
    def create_response(
        ...
        return MessageBuilder.create_message(
            source_service="audio_classifier_service",
    ...
    def create_classification_result_message(
        ...
        """創建音頻分類結果消息"""
        result_path = classification_results.get("parameters", {}).get("classification_result_path")
        processing_time = classification_results.get("parameters", {}).get("processing_time_seconds", 0)
        payload = {
