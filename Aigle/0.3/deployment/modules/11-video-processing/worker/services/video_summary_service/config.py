# services/video_summary_service/config.py
...
KAFKA_TOPIC_DLQ = "video-summary-dlq"
...
ASYNC_PROCESSING_CONFIG = {
    ...
    "task_timeout": 120,                # 單個任務超時時間
    "enable_task_monitoring": True,      # 啟用任務監控
}

# 服務配置
SERVICE_NAME = "video_summary_service"
LOG_LEVEL = "INFO"
...
# Ollama 配置
#OLLAMA_URL = "http://192.168.57.156:8010"
#OLLAMA_MODEL = "qwenforsummary"

# VideoSummary 配置
VIDEO_SUMMARY_CONFIG = {
    "max_tokens_per_batch": int(os.environ.get("SUMMARY_MAX_TOKENS", 1600)),
    "max_summary_length": int(os.environ.get("SUMMARY_MAX_LENGTH", 300)),
}
