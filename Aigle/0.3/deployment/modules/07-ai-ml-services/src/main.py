...
from .api import models_api, datasets_api, gpu_api, config_api, inference_api, tts_api
...
# Training endpoints moved to separate training-service (Module 14)
    ...
    try:
        ...
        health_status = {
            ...
            "api_routes": {
                ...
                # Training API moved to separate training-service (Module 14)
            }
        }
...
def get_api_info():
    ...
    return {
        ...
        "available_endpoints": {
            ...
            # Training endpoints moved to separate training-service (Module 14)
            # Access training API at: http://training-service.aigle.local:8020/api/v1/training/*
        },
        "features": [
            "模型生命週期管理",
            "數據集版本控制", 
            ...
            "健康監控",
            "性能統計",
            # Training moved to separate service
        ]
    }
