...
API endpoints: http://192.168.157.167:8009/docs
MLflow tracking: http://192.168.157.167:5000/
Redis cache: http://192.168.157.123:5540/
TensorBoard: http://192.168.157.167:6006/
"""
...
# Configuration
AIML_BASE_URL = "http://192.168.157.167:8010"
TRAINING_BASE_URL = "http://192.168.157.163:8009"
...
def monitor_training(job_id: str):
    ...
    print("=" * 50)
    print(f"MLflow UI: http://192.168.157.163:5000/")
    print(f"Redis cache: http://192.168.157.123:5540/")
    print("=" * 50 + "\n")
