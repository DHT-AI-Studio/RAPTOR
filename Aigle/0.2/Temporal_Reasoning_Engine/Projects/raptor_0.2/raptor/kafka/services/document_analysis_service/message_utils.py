# services/document_analysis_service/message_utils.py
...
class MessageBuilder:
    ...
    def create_response(
        ...
        return MessageBuilder.create_message(
            source_service="document_analysis_service",
    ...
    @staticmethod
    def create_analysis_result_message(
        original_message: Dict[str, Any],
        ...
        payload = {
            ...
            "metadata": {
                ...
                "service": "document_analysis_service",
